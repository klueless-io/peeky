  ...
  describe 'Peaky#api' do
    ...
    describe '#build_class_info' do
      it 'builds class information with meta data for the target class - lazy loaded' do
        class_info = api.build_class_info(Sample::Usage1::SimpleClass.new)
      ...
      it 'builds class information with meta data for the target class - pre-loaded' do
        class_info = api.build_class_info(Sample::Usage1::ComplexClass.new, lazy: false)
    ...
    context '#render_class' do
      ...
      it 'render class_interface_yard with instance of intended class' do
        puts api.render_class(:class_interface_yard, instance: Sample::Usage1::SimpleClass.new)
      end
    end

    context '#render_class examples' do
      it 'render class_debug' do
        # puts api.render_class(:class_debug, instance: Sample::Usage1::SimpleClass.new)
        puts api.render_class(:class_debug, instance: Sample::Usage1::ComplexClass.new)
      end

      it 'render class_interface' do
        puts api.render_class(:class_interface, instance: Sample::Usage1::ComplexClass.new)
      end

      it 'render class_interface_yard' do
        puts api.render_class(:class_interface_yard, instance: Sample::Usage1::ComplexClass.new)
      end
    end
  end
end
